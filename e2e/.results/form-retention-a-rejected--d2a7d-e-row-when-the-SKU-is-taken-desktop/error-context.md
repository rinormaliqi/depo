...
- Name: form-retention.spec.ts >> a rejected submit keeps what the user typed >> adding an item keeps the row when the SKU is taken
- Location: e2e/form-retention.spec.ts:40:3
...
Expected: "QA retention probe"
Received: ""
Timeout:  10000ms

Call log:
  - Expect "toHaveValue" locator('input[name=name]') with timeout 10000ms
  - waiting for locator('input[name=name]')
    24 × locator resolved to <input required="" name="name" class="input" placeholder="Emri"/>
       - unexpected value ""
