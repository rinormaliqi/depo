...
- Name: form-retention.spec.ts >> a rejected submit keeps what the user typed >> login keeps the email after a wrong password
- Location: e2e/form-retention.spec.ts:13:3
...
Expected: "blerim@seed.smartdepo.test"
Received: ""
Timeout:  10000ms

Call log:
  - Expect "toHaveValue" locator('input[name=email]') with timeout 10000ms
  - waiting for locator('input[name=email]')
    24 × locator resolved to <input required="" type="email" name="email" class="input" placeholder="you@company.com"/>
       - unexpected value ""
