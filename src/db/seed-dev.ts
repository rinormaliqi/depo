...
const ORGS: SeedOrg[] = [
  {
    ...
    facilities: [{ name: "Depo Kryesore", widthM: 24, heightM: 16, template: "flowU", fillPct: 0.5 }],
    itemCount: 20,
    catalogue: "electro",
  },
  {
    ...
    facilities: [
      { name: "Depo Fushë Kosovë", widthM: 40, heightM: 24, template: "flowI", fillPct: 0.65 },
      { name: "Depo Graçanicë", widthM: 30, heightM: 20, template: "flowU", fillPct: 0.3 },
    ],
    itemCount: 150,
  ...
  },
  {
    ...
    facilities: [{ name: "Magazina", widthM: 32, heightM: 20, template: "flowI", fillPct: 0.4 }],
    itemCount: 60,
    catalogue: "electro",
  },
  {
    ...
    facilities: [{ name: "Depo Barnash", widthM: 20, heightM: 14, template: "flowU", fillPct: 0.8 }],
    itemCount: 30,
    catalogue: "pharma",
  },
  {
    ...
    facilities: [{ name: "Depo Pjesësh", widthM: 28, heightM: 18, template: "flowU", fillPct: 0.55 }],
    itemCount: 80,
    catalogue: "auto",
  },
  {
    ...
    facilities: [
      { name: "Fabrika Prizren", widthM: 48, heightM: 30, template: "flowI", fillPct: 0.7 },
      { name: "Depo Suharekë", widthM: 30, heightM: 20, template: "flowU", fillPct: 0.45 },
      { name: "Dyqani Prishtinë", widthM: 16, heightM: 12, template: "flowU", fillPct: 0.9 },
    ],
    itemCount: 200,
    catalogue: "textile",
  },
  ...
  for (const s of specs) {
    ...
    const [created] = await db
      ...
      .values({
        ...
        kind: s.kind,
        name: s.name ?? type.label.toUpperCase(),
        color: s.kind === "zone" ? (s.color ?? null) : null,
        code,
        isBin: isLeaf,
        xM: s.xM,
        yM: s.yM,
